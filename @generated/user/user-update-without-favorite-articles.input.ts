...
import { UserUpdateManyWithoutFollowersNestedInput } from './user-update-many-without-followers-nested.input.ts';
...
export class UserUpdateWithoutFavoriteArticlesInput {
  ...
  following?: Identity<UserUpdateManyWithoutFollowersNestedInput>;
