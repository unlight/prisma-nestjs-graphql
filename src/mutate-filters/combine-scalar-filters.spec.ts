...
describe('combine scalar filters', () => {
    it('replacement type name scalars', () => {
        expect(replacementTypeName('StringNullableFilter')).toEqual(
            'StringFilter',
        );
        expect(replacementTypeName('NullableStringFilter')).toEqual(
            'StringFilter',
        );
        expect(replacementTypeName('NestedStringNullableFilter')).toEqual(
            'StringFilter',
        );
        expect(replacementTypeName('NestedStringFilter')).toEqual(
            'StringFilter',
        );
        ...
        expect(replacementTypeName('NestedIntNullableFilter')).toEqual(
            'IntFilter',
        );
        expect(replacementTypeName('NestedIntFilter')).toEqual('IntFilter');
        expect(replacementTypeName('FloatNullableFilter')).toEqual(
            'FloatFilter',
        );
        expect(replacementTypeName('NullableFloatFilter')).toEqual(
            'FloatFilter',
        );
        ...
        expect(replacementTypeName('NestedBooleanFilter')).toEqual(
            'BooleanFilter',
        );
        expect(replacementTypeName('BoolNullableFilter')).toEqual(
            'BooleanFilter',
        );
        expect(replacementTypeName('NestedBoolNullableFilter')).toEqual(
            'BooleanFilter',
        );
        expect(replacementTypeName('NestedBoolFilter')).toEqual(
            'BooleanFilter',
        );
    });
